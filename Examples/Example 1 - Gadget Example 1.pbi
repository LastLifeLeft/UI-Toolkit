...
; 
; Gadget = UITK::Radio(#PB_Any, 740, 20, 200, 28, "Radio 1", "Example group 1", UITK::#HAlignRight)
; Gadget = UITK::Radio(#PB_Any, 740, 60, 200, 28, "Radio 2", "Example group 1", UITK::#HAlignRight)
; Gadget = UITK::Radio(#PB_Any, 740, 100, 200, 28, "Radio 3", "Example group 1", UITK::#HAlignRight)
; Gadget = UITK::Radio(#PB_Any, 740, 140, 200, 28, "Radio 4", "Example group 1", UITK::#HAlignRight)
; 
...
Gadget = UITK::Radio(#PB_Any, 740, 20, 200, 28, "Radio 1", "Example group 2", UITK::#HAlignRight)
Gadget = UITK::Radio(#PB_Any, 740, 60, 200, 28, "Radio 2", "Example group 2", UITK::#HAlignLeft)
Gadget = UITK::Radio(#PB_Any, 740, 100, 200, 28, "Radio 3", "Example group 2", UITK::#HAlignCenter)
Gadget = UITK::Radio(#PB_Any, 740, 140, 200, 28, "Radio 4", "Example group 2", UITK::#HAlignRight)
