...
Window0 = UITK::Window(#PB_Any, (Width - 1024) * 0.5 - 200, (Height - 600) * 0.5 - 100, 1024, 600, "UI Toolkit : component showcase", UITK::#Window_CloseButton)
...
Window1 = UITK::Window(#PB_Any, (Width - 1024) * 0.5, (Height - 600) * 0.5, 1024, 600, "UI Toolkit : dark theme", UITK::#DarkMode | UITK::#Window_CloseButton | UITK::#HAlignCenter)
...
Gadget = UITK::TrackBar(#PB_Any, 260, 330, 200, 40, 0, 100, UITK::#DarkMode | UITK::#VAlignTop)
AddGadgetItem(Gadget, 0, "x.5")
AddGadgetItem(Gadget, 13, "x1")
AddGadgetItem(Gadget, 100, "x4")
SetGadgetState(Gadget, 31)

Gadget = UITK::TrackBar(#PB_Any, 260, 390, 60, 180, 0, 4, UITK::#DarkMode | UITK::#Trackbar_Vertical)
AddGadgetItem(Gadget, 0, "Low")
AddGadgetItem(Gadget, 4, "High")
