...
AddGadgetItem(Gadget, -1, "Name", 0, UITK::#PropertyBox_Text)
SetGadgetItemText(Gadget, 1, "Player one", 1)
AddGadgetItem(Gadget, -1, "Health", 0, UITK::#PropertyBox_TextNumerical)
SetGadgetItemText(Gadget, 2, "100", 1)
AddGadgetItem(Gadget, -1, "Tint", 0, UITK::#PropertyBox_Color)
SetGadgetItemState(Gadget, 3, RGB(80, 160, 240))
AddGadgetItem(Gadget, -1, "Difficulty", 0, UITK::#PropertyBox_Combo)
SetGadgetItemText(Gadget, 4, "Easy" + #LF$ + "Normal" + #LF$ + "Hard", 1)
SetGadgetItemState(Gadget, 4, 1)
AddGadgetItem(Gadget, -1, "Fullscreen", 0, UITK::#PropertyBox_CheckBox)
