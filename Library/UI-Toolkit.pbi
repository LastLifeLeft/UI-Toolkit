...
Module UITK
	...
	*DefaultTheme = @LightTheme
	...
	;{ ParameterList
	; A table of named expressions - the name, the expression, and what it reads as - in foldable groups. Like the TimeLine and the LayerList it costs nothing unless an EnableParameterList module is declared above the include.
	CompilerIf Defined(EnableParameterList, #PB_Module)
...
; CursorPosition = 16111
; Folding = AAAw---BAAAAAAAAAAAAAAAAAgPcAA+DAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA+
; EnableXP
; DPIAware